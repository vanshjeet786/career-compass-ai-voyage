...
export const LAYER_6_QUESTIONS: Record<string, string[] | { instructions: string; questions: string[] }> = {
  "Self_Synthesis": [
    ...
    "My top 3 career interest areas are: (multi-input)",
    "A role I now want to research deeper or shadow is: (open-ended)",
  ],
  "Passion_Practicality": {
    instructions: "Now, let's evaluate the three career interests you identified in the Self-Synthesis section. For each 'Career X' below, think back to the specific career areas you listed in question 6 above. Rate how you feel about each aspect using the 5-point scale.",
    questions: [
