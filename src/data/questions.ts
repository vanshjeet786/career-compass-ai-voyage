...
export const LAYER_6_QUESTIONS: Record<string, string[] | { instructions: string; questions: string[] }> = {
  ...
  "Passion_Practicality": {
    instructions: "Now rate each of your 3 career interests from the previous section on the following dimensions. This will help you evaluate passion vs practicality for each option.",
    questions: [
